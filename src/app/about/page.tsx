      ...
      <section className={styles.processSection}>
        <div className="container">
          ...
          <div className={styles.processGrid}>
            <div className={`${styles.processCard} animate-fade-up`} style={{ animationDelay: '0.6s' }}>
            ...
            <div className={`${styles.processCard} animate-fade-up`} style={{ animationDelay: '0.7s' }}>
            ...
            <div className={`${styles.processCard} animate-fade-up`} style={{ animationDelay: '0.8s' }}>
            ...
            <div className={`${styles.processCard} animate-fade-up`} style={{ animationDelay: '0.9s' }}>
